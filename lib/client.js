...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '.qp-item{display:flex;flex-direction:row;align-items:center;gap:8px;text-align:left;border:none;background:transparent;border-radius:8px;padding:4px 10px;cursor:pointer;width:100%}',
      '.qp-item:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(0,0,0,.06))}',
      '.qp-item-title{font-size:12px;font-weight:600;color:var(--dsw-alias-label-primary,inherit);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:none;max-width:45%}',
      '.qp-item-text{flex:1;font-size:12px;color:var(--dsw-alias-label-secondary,#777);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0}',
      /* 管理编辑行 */
